...
Data is used in many application domains. We provide a brief and certainly not exhaustive list of some domains, along with a simple example for each domain. We adapt the list provided in [4].
...
Financial data is used to analyze trends, behaviors, and patterns within financial markets, institutions, and transactions. The primary types of financial data include:
...
The list above is adapted from [5] and [6].
